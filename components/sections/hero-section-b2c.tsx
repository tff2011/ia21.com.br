    ...
    <section className="relative bg-gradient-to-br from-background via-background to-muted/20 py-12 sm:py-16 lg:py-20 px-4 sm:px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight tracking-tight break-words max-w-[22ch] sm:max-w-[28ch]">
                <span className="text-[#0B0B0B] font-black">Torne-se o</span>
                <span className="bg-gradient-to-r from-[#C8A253] to-[#B8860B] bg-clip-text text-transparent font-black"> Profissional</span>
                <br className="hidden sm:block" />
                <span className="text-[#0B0B0B] font-black"> Mais Valorizado</span>
                <br className="block" />
                <span className="text-[#0B0B0B] font-black">da Sua</span>
                <span className="bg-gradient-to-r from-[#C8A253] to-[#B8860B] bg-clip-text text-transparent font-black"> Área</span>
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-prose">
                Acesso vitalício a todas as ferramentas, técnicas e atualizações de IA -
                <span className="font-bold text-foreground"> saia na frente de 87% do mercado que ainda não domina Inteligência Artificial</span>
              </p>
            </div>
          ...
          {/* Mobile-only: Social proof and CTAs (placed after video) */}
