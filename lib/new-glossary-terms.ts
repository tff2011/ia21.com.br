// Novos termos do glossário A-Z focados em LLM e IAs Generativas
// Explicações adaptadas para adolescentes leigos
import { Brain, Code, Lightbulb, Database, BookOpen } from "lucide-react"

export const newGlossaryTerms = [
  {
    id: "1",
